    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                ...
                <form action="{{ route('index_saham.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Index Char" type="text" name="index_char" id="index_char">
                                </div>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Tahun" type="text" name="tahun" id="tahun">
                                </div>
                            </div>
                            </div>
                        </div>
